ciclistas = []
def recibir_datos():
    input("Introduce los datos de los ciclistas o escribe 'menu' para finalizar la entrada de datos y acceder al menú.")
    while True:
        ...
        ciclista = (codigo, nombre, edad, pais, equipo, tiempo)
